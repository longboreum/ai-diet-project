...
if "total_carb" not in st.session_state:
...
st.write(
    "목표 칼로리 :",
    round(target_calorie),
    "kcal"
)

st.write(
    "목표 단백질 :",
    round(target_protein),
    "g"
)
...
if uploaded_file is not None:
    ...
    if st.button(
        ...
        if st.session_state.total_kcal not in st.session_state.weekly_calories:

            st.session_state.weekly_calories.append(
...
st.write(
    "총 단백질 :",
    st.session_state.total_protein,
    "g"
)

st.write(
    "총 탄수화물 :",
    st.session_state.total_carb,
    "g"
)

st.write(
    "총 지방 :",
    st.session_state.total_fat,
    "g"
)

st.write(
    "야식 횟수 :",
    st.session_state.night_count,
    "회"
)
...
if st.button(
    ...
    if score not in st.session_state.weekly_scores:

        st.session_state.weekly_scores.append(
            score
        )
